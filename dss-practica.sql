...
EXEC InsertRandomCrewMembers @NumberOfCrewMembers = 800; -- Ajusta el número según sea necesario
...
EXEC InsertRandomCrewData @NumberOfCrews = 500; -- Cambia 500 por el número deseado
